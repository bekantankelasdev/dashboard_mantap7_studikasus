...
if (isset($_GET['data_kc'])) {
    ...
    $sql = "SELECT SUM(lending_bulan_berjalan) as lending_bulan_berjalan, lending_nama_unit FROM lending WHERE landing_create_at <= '$value_tanggal_awal' && landing_create_at >= '$value_tanggal_akhir' group by lending_nama_unit";
} else {
